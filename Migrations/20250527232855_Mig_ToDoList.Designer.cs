...
namespace SatışProject.Migrations
{
    ...
    [Migration("20250527232855_Mig_ToDoList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SatışProject.Entities.Basket", b =>
                {
            ...
            modelBuilder.Entity("SatışProject.Entities.BasketItem", b =>
                {
            ...
            modelBuilder.Entity("SatışProject.Entities.Message", b =>
                {
            ...
            modelBuilder.Entity("SatışProject.Entities.MessageRecipient", b =>
                {
                    b.Property<int>("MessageRecipientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageRecipientId"));
            ...
            modelBuilder.Entity("SatışProject.Entities.ToDoItem", b =>
                {
            ...
            modelBuilder.Entity("SatışProject.Entities.BasketItem", b =>
                {
                    b.HasOne("SatışProject.Entities.Basket", "Basket")
            ...
            modelBuilder.Entity("SatışProject.Entities.Message", b =>
                {
                    b.HasOne("SatışProject.Entities.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SatışProject.Entities.MessageRecipient", b =>
                {
                    b.HasOne("SatışProject.Entities.Message", "Message")
                        .WithMany("Recipients")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SatışProject.Entities.AppUser", "Recipient")
                        .WithMany()
