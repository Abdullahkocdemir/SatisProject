...
{
    /// <inheritdoc />
    public partial class Mig_WebSitesi_Düzenlemeleri_Yapıldı : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSurname = table.Column<string>(type: "VarChar", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Whies", x => x.WhyUsId);
                });
        }
